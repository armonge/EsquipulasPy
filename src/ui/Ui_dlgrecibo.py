...
#
# Created: Fri Jul 23 01:03:10 2010
...
class Ui_dlgRecibo(object):
    def setupUi(self, dlgRecibo):
        ...
        self.gridLayout_2.addWidget(self.txtpersona, 1, 1, 1, 3)
    ...
    def retranslateUi(self, dlgRecibo):
        ...
        self.label_2.setText(QtGui.QApplication.translate("dlgRecibo", "Recibo No.", None, QtGui.QApplication.UnicodeUTF8))
        self.lblnrec.setText(QtGui.QApplication.translate("dlgRecibo", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("dlgRecibo", "&Fecha", None, QtGui.QApplication.UnicodeUTF8))
        self.dtPicker.setDisplayFormat(QtGui.QApplication.translate("dlgRecibo", "dd/MM/yyyy", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("dlgRecibo", "Recibimos de:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("dlgRecibo", "En concepto de:", None, QtGui.QApplication.UnicodeUTF8))
        self.ckretener.setText(QtGui.QApplication.translate("dlgRecibo", "Con Retención", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_7.setText(QtGui.QApplication.translate("dlgRecibo", "Retención No.", None, QtGui.QApplication.UnicodeUTF8))
        self.lblnreten.setText(QtGui.QApplication.translate("dlgRecibo", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_20.setText(QtGui.QApplication.translate("dlgRecibo", "Observaciones ", None, QtGui.QApplication.UnicodeUTF8))
        self.label_19.setText(QtGui.QApplication.translate("dlgRecibo", "Total Retenido", None, QtGui.QApplication.UnicodeUTF8))
        self.lbltotalreten.setText(QtGui.QApplication.translate("dlgRecibo", "0", None, QtGui.QApplication.UnicodeUTF8))
