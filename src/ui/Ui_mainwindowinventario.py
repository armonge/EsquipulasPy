...
#
# Created: Mon Oct  4 22:44:20 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/res/view-bank-account.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnServices.setIcon(icon3)
        self.btnServices.setIconSize(QtCore.QSize(64, 64))
        self.btnServices.setFlat(False)
        self.btnServices.setObjectName(_fromUtf8("btnServices"))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/res/llanta.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnArticles.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/res/estante.jpg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnCategories.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/res/marca.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnBrands.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/res/resource-group.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnProviders.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/res/object-locked.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLockSession.setIcon(icon8)
        self.actionLockSession.setObjectName(_fromUtf8("actionLockSession"))
        self.actionUnlockSession = QtGui.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/res/object-unlocked.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUnlockSession.setIcon(icon9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnServices.setText(QtGui.QApplication.translate("MainWindow", "Otras Compras", None, QtGui.QApplication.UnicodeUTF8))
