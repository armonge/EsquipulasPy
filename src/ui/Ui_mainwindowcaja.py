...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnpos = QtGui.QPushButton(self.page)
        self.btnpos.setEnabled(False)
        self.btnpos.setMinimumSize(QtCore.QSize(0, 70))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setWeight(75)
        font.setBold(True)
        self.btnpos.setFont(font)
        self.btnpos.setAutoFillBackground(False)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/res/estante.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnpos.setIcon(icon2)
        self.btnpos.setIconSize(QtCore.QSize(64, 64))
        self.btnpos.setFlat(False)
        self.btnpos.setObjectName("btnpos")
        self.gridLayout.addWidget(self.btnpos, 1, 0, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/res/preferences-desktop-personal.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnClients.setIcon(icon3)
        self.btnClients.setIconSize(QtCore.QSize(64, 64))
        self.btnClients.setFlat(False)
        self.btnClients.setObjectName("btnClients")
        self.gridLayout.addWidget(self.btnClients, 2, 0, 1, 1)
        self.btnConceptos = QtGui.QPushButton(self.page)
        self.btnConceptos.setEnabled(False)
        ...
        self.btnConceptos.setIcon(icon3)
        ...
        self.gridLayout.addWidget(self.btnConceptos, 3, 0, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/res/simbolo-dolar-300x245.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnfactura.setIcon(icon4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnpos.setText(QtGui.QApplication.translate("MainWindow", "Puntos de \n"
"Caja", None, QtGui.QApplication.UnicodeUTF8))
