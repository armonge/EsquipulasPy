...
class Ui_frmArqueo(object):
    def setupUi(self, frmArqueo):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblTotalArqueo.sizePolicy().hasHeightForWidth())
        self.lblTotalArqueo.setSizePolicy(sizePolicy)
        self.lblTotalArqueo.setObjectName("lblTotalArqueo")
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.FieldRole, self.lblTotalArqueo)
        ...
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.lblTotalSesion)
        ...
        self.formLayout_2.setItem(0, QtGui.QFormLayout.LabelRole, spacerItem1)
